...
/**
 * <p>Clase que "enumera" el poder para abrir puertas.</p>
 *
 ...
 * programa a través de la variable de clase {@link AbrePuertas#INSTANCIA}</p>
 */
public class AbrePuertas implements PoderItem {
    /**
     * Única instancia de la clase
     */
    public static final AbrePuertas INSTANCIA = new AbrePuertas();
    private AbrePuertas() {
    }
}