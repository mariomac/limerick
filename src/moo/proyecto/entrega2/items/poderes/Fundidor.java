...
/**
 * <p>Clase que "enumera" el poder para fundir hielo.</p>
 *
 ...
 * programa a través de la variable de clase {@link Fundidor#INSTANCIA}</p>
 */
public class Fundidor implements PoderItem {
    /**
     * Única instancia de la clase
     */
    public static final Fundidor INSTANCIA = new Fundidor();
    private Fundidor() {
